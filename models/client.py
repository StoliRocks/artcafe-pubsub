...
class Client(BaseModel):
    ...
    client_id: str = Field(default_factory=lambda: str(ULID()), description="Client ID")
    ...
    permissions: ClientPermissions = Field(
        default_factory=ClientPermissions,
    ...
    class Config:
        json_schema_extra = {
            "example": {
                "client_id": "01HXYZ123456789ABCDEFGHIJ",
